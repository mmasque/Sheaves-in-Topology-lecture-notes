...
\begin{lem}[name={Yoneda Lemma~\cite[Theorem~2.2.4]{riehlCategoryTheoryContext2016}}]\label{lem:yoneda}
...
It is, however, when $F$ is \emph{constructible}, which we will see in one of the final lectures.\todo{Ref back}
\end{rmk}
...
\end{prop}
\begin{proof}
    We can cheat and use the unproven remark that the étalé space is a coend. \todo{prove?}
\end{proof}
