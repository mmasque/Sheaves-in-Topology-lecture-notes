...
\end{defn}
\begin{exmp}
	The category of abelian groups $\catAbelianGroup$ and more generally the category of modules over a ring $\catModule_R$ are abelian categories, and the coimage-image isomorphims in these categories is the first isomorphism theorem: $X/\ker(f) \xrightarrow{\sim} \im(f)$.
\end{exmp}
